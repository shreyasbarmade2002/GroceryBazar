        ...
        {homePage.homePageData?.deals &&    <section className='pt-10'>
           ...
           {homePage.homePageData?.shopByCategories && <section className='flex flex-col justify-center items-center py-20 px-5 lg:px-20'>
            ...
            <section className='lg:px-20 relative h-[200px] lg:h-[450px] object-cover'>
                <img className='w-full h-full' src = "https://img.freepik.com/free-photo/copy-space-woman-holding-cartoon-box-with-vegetables_23-2148875902.jpg?t=st=1739221344~exp=1739224944~hmac=86bd9db48033f83b1282b5f1f399a5fc7636e4846eee187ce7af2b3b1828b2b9&w=1800" alt="" />
                <div className='absolute top-1/2 left-4 lg:left-[15rem] transform  -translate-y-1/2 font-semibold lg:text-4xl space-y-3 '>
                    <h1 className=''>
                        Sell Your Product
                    </h1>
                    <p className='text-lg md:text-2xl'>With <strong className='logo text-3xl md:text-5xl pl-2'>GroceryBazar</strong></p>
