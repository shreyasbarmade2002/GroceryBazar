    ...
    <div className="grid md:gap-10 grid-cols-3 min-h-screen ">
      ...
      <section className=" hidden md:col-span-1 md:flex  lg:col-span-2  justify-center items-center">
        <div className="lg:w-[70%] px-5 space-y-10">
          ...
          <img className="" src= "https://img.freepik.com/premium-photo/young-couple-vegetarians-unpacking-shopping-back-with-fresh-green-product-kitchen-home_506452-9580.jpg?w=2000" alt="" />
          {/* <div>
